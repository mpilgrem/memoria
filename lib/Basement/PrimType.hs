...
sizeInBytes = sizeOfE (primSizeInBytes (Proxy :: Proxy a))

offsetInBytes :: forall a . PrimType a => Offset a -> Offset Word8
offsetInBytes = offsetShiftL (primShiftToBytes (Proxy :: Proxy a))
...
offsetInElements = offsetShiftR (primShiftToBytes (Proxy :: Proxy a))
