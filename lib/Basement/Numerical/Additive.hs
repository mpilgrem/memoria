...
import           Basement.Compat.Primitive
                   ( plusInt16#, plusInt32#, plusInt8#, plusWord16#, plusWord32#
                   , plusWord8#
                   )
import           Basement.Numerical.Number
import           Basement.Bounded ( Zn, Zn64, zn64, zn )
import           Basement.Nat
...
import           Prelude ( Enum (..), Integer, Num )
...
class Additive a where
    ...
    default scale :: (Enum n, IsNatural n, Num n) => n -> a -> a
    scale = scaleEnum

scaleEnum :: (Additive a, Enum n, IsNatural n, Num n) => n -> a -> a
scaleEnum 0 _ = azero
scaleEnum 1 a = a
scaleEnum 2 a = a + a
