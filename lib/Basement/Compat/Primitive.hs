...
import           GHC.Exts
                   ( ByteArray#, Char#, Int#, MutableByteArray#, chr#
                   , intToInt16#, intToInt32#, int16ToInt#, int8ToInt#
                   , isByteArrayPinned#, isMutableByteArrayPinned#, isTrue#
                   , plusInt32#, plusWord32#, unsafeCoerce#, wordToWord16#
                   , wordToWord32#, wordToWord8#, word16ToWord#, word2Int#
                   , word32ToWord#, word8ToWord#
                   )
#if __GLASGOW_HASKELL__ >= 902
import           GHC.Exts
                   ( Word8#, Word16#, Word32#, Int8#, Int16#, Int32#, plusWord8#
                   , plusWord16#, plusInt8#, plusInt16#
                   )
#endif
...
toPinnedStatus# :: Int# -> PinnedStatus
...
compatIsByteArrayPinned# :: ByteArray# -> Int#
compatIsByteArrayPinned# = isByteArrayPinned#

compatIsMutableByteArrayPinned# :: MutableByteArray# s -> Int#
compatIsMutableByteArrayPinned# = isMutableByteArrayPinned#
